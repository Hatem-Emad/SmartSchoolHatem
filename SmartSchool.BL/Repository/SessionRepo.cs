    ...
    public class SessionRepo : ISessionRepo
    {
        ...
        public Session Create(SessionDTO obj)
        {
            var existSession = Db.Sessions.Where(s =>
                (s.SessionNo == obj.SessionNo && s.ScheduleID == obj.ScheduleID && s.Schedule.Class.Name == obj.ClassName) 
              ||(s.SessionNo == obj.SessionNo && s.TeacherID == obj.TeacherID && s.ScheduleID == obj.ScheduleID)
            ).FirstOrDefault();
